...
trip_info_file = folder_path / 'simulation-simulation-output-files' / 'tripinfo.xml'
statistics_file = folder_path / 'simulation-simulation-output-files' / 'statistics_output.xml'
